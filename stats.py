...
def make_stats(data):
    html_template = '''<div class="mt-8 ml-6 w-67 h-[220px] z-20">
                ...
                <div class="flex flex-row justify-between mt-4">
                    <div class="pill-with-badge relative flex flex-row h-11"><span class="bg-black rounded-full z-10">
                            <div class="h-full text-white flex flex-col justify-center align-center w-11 text-2xl"><img src="#wtype#" class="rounded-full w-11 border-solid border-2 border-black"></div>
                        </span>
                    ...
                    <div class="pill-with-badge relative flex flex-row h-11"><span class="bg-black rounded-full z-10">
                            <div class="h-full text-white flex flex-col justify-center align-center w-11 text-2xl"><img src="#rtype#" class="rounded-full w-11 border-solid border-2 border-black"></div>
                        </span>
                    ...
                    <div class="pill-with-badge relative flex flex-row h-11"><span class="bg-black rounded-full z-10">
                            <div class="h-full text-white flex flex-col justify-center align-center w-11 text-2xl"><img src="#dtype#" class="rounded-full w-11 border-solid border-2 border-black"></div>
                        </span>
    ...
    replaced_html = replaced_html.replace("#ALTER#",str(data["Alter Ego"]))
    ...
    replaced_html = replaced_html.replace("#RESISTANCE#",str(data["Resistant Defense"]))
